...
import { FunnelPostHogProvider } from "@/components/funnel-posthog-provider";
import "./globals.css";
...
export const metadata: Metadata = {
  title: "QuotVid Funnels",
  description: "QuotVid acquisition funnels — Pinterest and more.",
};
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        ...
        <FunnelPostHogProvider>{children}</FunnelPostHogProvider>
      </body>
    </html>
  );
}
